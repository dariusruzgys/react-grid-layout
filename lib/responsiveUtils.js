...
export const DefaultBreakpoints = "lg" | "md" | "sm" | "xs" | "xxs";

// + indicates read-only
export const ResponsiveLayout<T: Breakpoint> = {
  +[breakpoint: T]: Layout
};
export const Breakpoints<T: Breakpoint> = {
  +[breakpoint: T]: number
};

export OnLayoutChangeCallback = (
  Layout,
